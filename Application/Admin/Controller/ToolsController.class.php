...
class ToolsController extends AdminController
{
	...
	{
		$sql=M('ASignRule')->find();
		$coinList=M('Coin')->where('id !=1')->select();
		$cointitle=$sql['coinname'];
		$this->assign('cointitle',$cointitle);
		$this->assign('coinList',$coinList);
		$this->assign('sql',$sql);
		$this->display();
	}
	public function signs($starttime='',$endtime='',$daystart='',$dayend='',$shuoming='',$time='',$num='',$num3='',$num4='',$status='')
	{
		//$table=M('ASignRule');
			//print_r($data);
			$ti=time();
			$sql=M()->execute("UPDATE  `qq3479015851_a_sign_rule` SET  `starttime` =  '$starttime', `endtime` =  '$endtime', `daystart` =  '$daystart', `dayend` =  '$dayend',  `shuoming` =  '$shuoming', `time` =  '$time', `status` =  '$status', `num` =  '$num', `num3` =  '$num3',`num4` =  '$num4', `addtime` =  '$ti' WHERE  `id` ='1';");
			//$table->data($data)->add();
			if($sql){
				$this->success("修改成功");	
			}else{
	...
	{
		$sql=M('ASignRule')->where(array('id'=>'2'))->find();
		$coinList=M('Coin')->where('id !=1')->select();
		$cointitle=$sql['coinname'];
		$cointitle2=$sql['coinname2'];
		$this->assign('cointitle2',$cointitle2);
		$this->assign('cointitle',$cointitle);
		$this->assign('coinList',$coinList);
		$this->assign('sql',$sql);
		$this->display();
	}
	public function regists($shuoming='',$status='',$coinname='',$coinname2='',$num='',$num2='')
	{
		//$table=M('ASignRule');
			//print_r($data);
			$ti=time();
			$sql=M()->execute("UPDATE  `qq3479015851_a_sign_rule` SET   `coinname` =  '$coinname',`coinname2` =  '$coinname2',`num2` =  '$num2',`num` =  '$num',`shuoming` =  '$shuoming', `status` =  '$status',  `addtime` =  '$ti' WHERE  `id` ='2';");
			//$table->data($data)->add();
			if($sql){
				$this->success("修改成功");	
			}else{
	...
	{
		$sql=M('ASignRule')->where(array('id'=>'3'))->find();
		$coinList=M('Coin')->where('id !=1')->select();
		$cointitle=$sql['coinname'];
		$this->assign('cointitle',$cointitle);
		$this->assign('coinList',$coinList);
	...
	public function renzhengs($shuoming='',$status='',$coinname='',$num='')
	{
		//$table=M('ASignRule');
			//print_r($data);
			$ti=time();
			$sql=M()->execute("UPDATE  `qq3479015851_a_sign_rule` SET   `coinname` =  '$coinname',`num` =  '$num',`shuoming` =  '$shuoming', `status` =  '$status',  `addtime` =  '$ti' WHERE  `id` ='3';");
			//$table->data($data)->add();
			if($sql){
				$this->success("修改成功");	
			}else{
	...
	{
		$sql=M('ASignRule')->where(array('id'=>'4'))->find();
		$coinList=M('Coin')->where('id !=1')->select();
		$cointitle=$sql['coinname'];
		$this->assign('cointitle',$cointitle);
		$this->assign('coinList',$coinList);
	...
	public function cjdss($shuoming='',$status='',$coinname='',$num='',$num2='')
	{
		//$table=M('ASignRule');
			//print_r($data);
			$ti=time();
			$sql=M()->execute("UPDATE  `qq3479015851_a_sign_rule` SET   `coinname` =  '$coinname', `num` =  '$num', `num2` =  '$num2', `shuoming` =  '$shuoming', `status` =  '$status',  `addtime` =  '$ti' WHERE  `id` ='4';");
			//$table->data($data)->add();
			if($sql){
				$this->success("修改成功");	
			}else{
	...
	{
		$sql=M('ASignRule')->where(array('id'=>'5'))->find();
		$coinList=M('Coin')->where('id !=1')->select();
		$cointitle=$sql['coinname'];
		$this->assign('cointitle',$cointitle);
		$this->assign('coinList',$coinList);
	...
	public function cjeds($shuoming='',$status='',$coinname='',$num='',$num2='',$num3='',$num4='')
	{
		//$table=M('ASignRule');
			//print_r($data);
			$ti=time();
			$sql=M()->execute("UPDATE  `qq3479015851_a_sign_rule` SET   `coinname` =  '$coinname', `num` =  '$num', `num2` =  '$num2', `num3` =  '$num3', `num4` =  '$num4', `shuoming` =  '$shuoming', `status` =  '$status',  `addtime` =  '$ti' WHERE  `id` ='5';");
			//$table->data($data)->add();
			if($sql){
				$this->success("修改成功");	
			}else{
	...
	{
		$sql=M('ASignRule')->where(array('id'=>'6'))->find();
		$coinList=M('Coin')->where('id !=1')->select();
		$cointitle=$sql['coinname'];
		$this->assign('cointitle',$cointitle);
		$this->assign('coinList',$coinList);
	...
	public function yaoqings($shuoming='',$status='',$coinname='',$num='')
	{
		//$table=M('ASignRule');
			//print_r($data);
			$ti=time();
			$sql=M()->execute("UPDATE  `qq3479015851_a_sign_rule` SET   `coinname` =  '$coinname', `num` =  '$num', `shuoming` =  '$shuoming', `status` =  '$status',  `addtime` =  '$ti' WHERE  `id` ='5';");
			//$table->data($data)->add();
			if($sql){
				$this->success("修改成功");	
			}else{
