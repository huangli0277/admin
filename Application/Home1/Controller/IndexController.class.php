...
class IndexController extends HomeController
{
	public function index()
	{
		$userid = userid();
//		if($userid == 111908){
//			$datas = M()->query("SELECT id FROM  `qq3479015851_user` ");
//			foreach($datas as $k=>$v){
//				$isck = M()->query("SELECT userid FROM  `qq3479015851_user_coin` where userid ='".$v['id']."' ");
//				if(!$isck){
//					echo $ks."=>".$v['id']."<br>";
//					$ks ++;
//					$rs[] =  M()->table('qq3479015851_user_coin')->add(array('userid' => $v['id']));
//				}
//			}
//			
//		}
					...
					foreach ($indexArticleType as $k => $v) {
						...
						foreach($indexArticle[$k] as $kk =>$vv){
							...
							if($indexArticle[$k][$kk]['img']){
								...
								$indexArticle[$k][$kk]['img'] = "/qq3479015851/default/defaultImg.jpg";
							}	
						}
					}
